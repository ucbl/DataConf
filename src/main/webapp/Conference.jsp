<article id="index">
     ...
     <section id="home">   
        ...
        <div class="none">
            <h1>${sessionScope.confName} Publications</h1> 
            <h2 style="text-align: center">Welcome to the ${sessionScope.confName} poster track mobile app</h2>
            <h3 style="text-align: center">From here, you can:</h3>
               <ul  class="list gradWhite">                                
                         <li><a href="scan" >Scan a QRcode</a></li>    
                   		 <li><a href="#searchPaper" class="event" data-controller="${sessionScope.tracksList[0].controller}"  id="${sessionScope.tracksList[0].trackId}">${sessionScope.tracksList[0].name}</a></li>
    ...
    <section id="searchByTrack">
        ...
        <div class="none">
            <h1></h1>
            <ul class="list gradWhite">
                     <c:forEach var="track" items="${sessionScope.tracksList}">
    ...
    <section id="searchByAuthor">
        ...
        <div class="form">
            ...
            <form action="/index.html" id="formSearchAuthor" class="searchform"   method="post">
                    ...
                    <input data-role="none" type="hidden" name="typeSearch" value="" />
                    <input data-role="none" type="hidden" name="conferenceSearch" value="${sessionScope.confName}" />
